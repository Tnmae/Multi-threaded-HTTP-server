...

{
...

  {
    ...
    response.insert(response.begin() + 59, user_ag_len_str.begin(), user_ag_len_str.end());
    ...
    if (file.good()) {
      ...
      response= "HTTP/1.1 200 OK\r\nContent-Type: application/octet-stream\r\nContent-Length: " + std::to_string(con.length()) + "\r\n\r\n" + con;
...

{
...

  {
    ...
    *new_socket = accept(server_fd, (struct sockaddr *)&client_addr, (socklen_t*)&client_addr_len); // client_socket
